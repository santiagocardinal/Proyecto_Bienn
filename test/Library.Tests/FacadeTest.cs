...
public class FacadeTests
{
   /* private Customer _testCustomer;
    ...
    [Test]
    public void CreateCustomer_ValidData_ReturnsSuccessMessage()
    {
        // Act
    ...
    [Test]
    public void ModifyCustomer_ValidField_ReturnsSuccessMessage()
    {
        // Arrange
        Facade.CreateCustomer("C1", "Juan", "Pérez", "juan@mail.com", "099123456", "M", DateTime.Now.AddYears(-30));
    ...
    [Test]
    public void ModifyCustomer_InvalidField_ReturnsErrorMessage()
    {
        // Arrange
        Facade.CreateCustomer("C1", "Juan", "Pérez", "juan@mail.com", "099123456", "M", DateTime.Now.AddYears(-30));
        
        // Act
        string result = Facade.ModifyCustomer("C1", "invalidField", "value");
        
        // Assert
        Assert.That(result, Does.Contain("no es válido"));
    }

    [Test]
    public void ModifyCustomer_NonExistingCustomer_ReturnsErrorMessage()
    {
        // Act
    ...
    [Test]
    public void SearchCustomer_ByName_NotExists_ReturnsErrorMessage()
    {
        // Act
        string result = Facade.SearchCostumer_ByName("NoExiste");
    ...
    [Test]
    public void ShowCustomers_BySellerId_WithCustomers_ReturnsCustomerList()
    {
        // Arrange
    ...
    [Test]
    public void ShowCustomers_BySellerId_NoCustomers_ReturnsMessage()
    {
        // Arrange
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void ShowCustomers_BySellerId_SellerNotFound_ReturnsErrorMessage()
    {
        // Act
    ...
    [Test]
    public void AddTag_Customer_ValidTag_ReturnsSuccessMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
    ...
    [Test]
    public void AddTag_Customer_DuplicateTag_ReturnsErrorMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
    ...
    [Test]
    public void AddTag_Customer_CustomerNotFound_ReturnsErrorMessage()
    {
        // Act
    ...
    [Test]
    public void LastInteraction_WithInteractions_ReturnsLastInteraction()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void LastInteraction_NoInteractions_ReturnsMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
    ...
    [Test]
    public void LastInteraction_CustomerNotFound_ReturnsErrorMessage()
    {
        // Act
    ...
    [Test]
    public void UnansweredInteractions_WithUnanswered_ReturnsReport()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void UnansweredInteractions_NoUnanswered_ReturnsMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
    ...
    [Test]
    public void UnansweredInteractions_CustomerNotFound_ReturnsErrorMessage()
    {
        // Act
    ...
    [Test]
    public void AssignCustomer_ValidData_ReturnsSuccessMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void AssignCustomer_CustomerNotFound_ReturnsErrorMessage()
    {
        // Arrange
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void CallRegister_ValidData_ReturnsSuccessMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void CallRegister_CustomerNotFound_ReturnsErrorMessage()
    {
        // Arrange
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void MeetingRegister_ValidData_ReturnsSuccessMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void MessageRegister_ValidData_ReturnsSuccessMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void MailRegister_ValidData_ReturnsSuccessMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void QuoteRegister_ValidData_ReturnsSuccessMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void SaleFromQuote_ValidQuote_ReturnsSuccessMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void SaleFromQuote_QuoteNotFound_ReturnsErrorMessage()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void SaleFromQuote_CustomerNotFound_ReturnsErrorMessage()
    {
        // Arrange
        Facade.sm.CreateSeller(_testSeller);
        
        // Act
        string result = Facade.SaleFromQuote("S1", "C999", DateTime.Now, "Cotización", ExchangeType.Sent, 1000.0, "Producto X");
    ...
    [Test]
    public void GetCustomerInteractions_WithInteractions_ReturnsInteractionsList()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
    ...
    [Test]
    public void GetCustomerInteractions_NoInteractions_ReturnsEmptyList()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        var facadeInstance = new Facade();
    ...
    [Test]
    public void GetCustomerInteractions_FilterByDate_ReturnsFilteredList()
    {
        // Arrange
        Facade.cm.AddCustomer(_testCustomer);
        Facade.sm.CreateSeller(_testSeller);
